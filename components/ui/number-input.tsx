...
const NumberInput = React.forwardRef<HTMLInputElement, MyNumberFieldProps>(({ ...props }, ref) => {
  return (
    <NumberField {...props} ref={ref}>
      ...
      >
        ...
        <Input className="w-full grow px-3 py-2 text-center tabular-nums bg-background" />
        <Button
          slot="increment"
